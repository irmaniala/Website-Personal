...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM formulir_tidak_ada WHERE id = ?";
...
$sql_berkas = "SELECT * FROM berkas_tidak_ada WHERE formulir_id = ?";
...
<head>
    ...
    <title>Edit Formulir Tidak Ada Barang Bukti</title>
    <link rel="stylesheet" href="css/formulir.css">
</head>
<body>

<div class="container">
    <h2>FORMULIR REGISTRASI KLIEN TAT PADA MASA PENANGKAPAN (APABILA TIDAK DIDAPATKAN BARANG BUKTI)</h2>

    <a href="lihat_formulir2.php">form2</a>

    <form id="formTersangka" action="updateForm2.php" method="POST" enctype="multipart/form-data">
